			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
    				...
    				<table class=" table table-striped"  width="300" border="0" cellspacing="2" cellpadding="2">
    				  <tbody>
    				    <tr>
                        <td rowspan="4" align="center"><img src="img/pf/<?=$data['pfPic'];?>" width="200"  class="img-rounded"></td>
                        <td>ชื่อผู้ใช้</td>
                      ...
                      <tr>
                        <td>ที่อยู่ในการจัดส่ง</td>
    				      ...
    				      <td><?=$data['address'];?><?=$data['address2'];?></td>
  				      </tr>
                      <tr>
                      <td>E-mail</td>
                    ...
                    $Sql2 = "SELECT * FROM orders o,status s where o.statusID=s.statusID AND o.memberid ='".$_SESSION['mID']."'";
					$Result2 = mysqli_query($conn,$Sql2);
					while($Data2 = mysqli_fetch_array($Result2)) {
					?>
                    <tr>
                    <td><?=$Data2['invoice'];?></td>
                    <td><?=$Data2['OrderDate'];?></td>
                    <td><?=$Data2['statusName'];?></td>
                    <td><a target="_blank" href="billing.php?id=<?=$Data2['Orderid'];?>"<span class="glyphicon glyphicon-check"></span></a></td>
                    </tr>
                    <?php
					}
					mysqli_close($conn);
