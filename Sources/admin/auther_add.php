...
include('config.php');
$sql2 = "select MAX(authID) as auth from auther";
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
          		  ...
          		  <form id="form1" name="form1" method="post" class="form-inline">
          		    <table>
          		      <tr>
          		        ...
          		        <td><input name="authID" type="text" class="form-control" value="<?=$ID?>" size="70" readonly></td>
       		          </tr>
          		      <tr>
          		        <td height="40">ชื่อผู้แต่ง :</td>
          		        <td><input name="authName" type="text" required class="form-control" autofocus size="70"></td>
       		          </tr>
          		      <tr>
          		        <td height="40">&nbsp;</td>
				  ...
				  $name = $_POST['authName'];
				  $sql ="Insert into auther values ('','$name')";
