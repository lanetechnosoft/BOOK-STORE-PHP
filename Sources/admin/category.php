...
<head>
<meta charset="utf-8">
<title>รายการหมวดหมู่หนังสือ</title>
...
<!--Side BarInclude -->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> รายการหมวดหมู่หนังสือ</h3>
    ...
    <?php
	 ...
	 @$kw = $_POST['kw'];
		$sql ="Select * from category where CatName like '%$kw%'";
    ...
    <tr>
      <td><?=$data['CatID']?></td>
      <td><?=$data['CatName']?></td>
      <td><a href="category_update.php?id=<?=$data['CatID']?>" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-pencil"></span> แก้ไข</a>
	  <a href="delete.php?n=cat&id=<?=$data['CatID']?>" onClick="return confirm('คุณแน่ใจไหมที่จะลบ <?=$data['CatName']?> ?');"class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span> ลบ</a></td>
	</tr>
    <?php
		}
