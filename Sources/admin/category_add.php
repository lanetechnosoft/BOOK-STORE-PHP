...
include('session.php');
include('config.php');
$sql2 = "select max(CatID) as cat from category";
          		  ...
          		  <form id="form1" name="form1" method="post" class="form-inline">
          		    <table>
          		      <tr>
          		        ...
          		        <td><input name="CatID" type="text" class="form-control" value="<?=$ID?>" readonly size="70"></td>
       		          </tr>
          		      <tr>
          		        <td height="40">ชื่อหมวดหมู่หนังสือ :</td>
          		        <td><input name="CateName" type="text" required class="form-control" autofocus size="70"></td>
       		          </tr>
          		      <tr>
          		        <td height="40">&nbsp;</td>
