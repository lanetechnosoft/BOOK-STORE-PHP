...
include('session.php');
include('config.php');
$sql2 = "select * from category where CatID='$_GET[id]'";
...
<head>
<meta charset="utf-8">
<title>เพิ่มหมวดหมู่หนังสือ</title>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>เพิ่มข้อมูลหมวดหมู่หนังสือ</h3>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		  <form id="form1" name="form1" method="post" class="form-inline">
          		    <table>
          		      <tr>
          		        <td width="200" height="40">รหัสหมวดหมู่ :</td>
          		        <td><input name="CatID" type="text" class="form-control" value="<?=$data2['CatID']?>" readonly size="70"></td>
       		          </tr>
          		      <tr>
          		        <td height="40">ชื่อหมวดหมู่หนังสือ :</td>
          		        <td><input name="CateName" type="text" required class="form-control" value="<?=$data2['CatName']?>" autofocus size="70"></td>
       		          </tr>
          		      <tr>
          		        <td height="40">&nbsp;</td>
				  ...
				  window.location='category_update.php?id=$_GET[id]'
				  </script>
				  ";
				  }
				  mysqli_close($conn);
