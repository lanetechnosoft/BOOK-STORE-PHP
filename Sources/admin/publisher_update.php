...
include('session.php');
include('config.php');
$sql2 = "select * from publisher where pubID='$_GET[id]'";
...
<head>
<meta charset="utf-8">
<title>เพิ่มสำนักพิมพ์ใหม่</title>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>เพิ่มข้อมูลข้อมูลสำนักพิมพ์</h3>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		  <form id="form1" name="form1" method="post" class="form-inline">
          		    <table>
          		      <tr>
          		        <td width="200" height="40">รหัสสำนักพิมพ์ :</td>
          		        <td><input name="pubID" type="text" class="form-control" value="<?=$data2['pubID']?>"  readonly size="70"></td>
       		          </tr>
          		      <tr>
          		        <td height="40">ชื่อสำนักพิมพ์ :</td>
          		        <td><input name="pubName" type="text" required class="form-control" size="70" value="<?=$data2['pubName']?>"  autofocus></td>
       		          </tr>
          		      <tr>
          		        <td height="40">&nbsp;</td>
          		        <td><input type="submit" name="submit" id="submit" value="เสร็จสิ้น" class="btn btn-primary"></td>
       		          </tr>
       		        </table>
       		      </form>
                  <?php
				  ...
				  window.alert('อัพเดทเรียบร้อย');
				  window.location='publisher_update.php?id=$_GET[id]';
				  </script>
				  ";
				  }
				  mysqli_close($conn);
