...
<!--Side BarInclude -->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> รายชื่อผู้แต่ง</h3>
    ...
    <?php
	 ...
	 @$kw = $_POST['kw'];
		$sql ="Select * from auther where authName like '%$kw%'";
    ...
    <tr>
      <td><?=$data['authID']?></td>
      <td><?=$data['authName']?></td>
      <td><a href="auther_update.php?id=<?=$data['authID']?>" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-pencil"></span> แก้ไข</a>
	      <a href="delete.php?n=auth&id=<?=$data['authID']?>" onClick="return confirm('คุณแน่ใจไหมที่จะลบ <?=$data['authName']?> ?');" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span> ลบ</a></td>
    </tr>
    <?php
		}
