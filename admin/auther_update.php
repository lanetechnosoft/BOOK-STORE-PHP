...
include('session.php');
include('config.php');
$sql2 = "select * from auther where authID='$_GET[id]'";
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>เพิ่มข้อมูลผู้แต่งหนังสือ</h3>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		  <form id="form1" name="form1" method="post" class="form-inline">
          		    <table>
          		      <tr>
          		        <td width="200" height="40">รหัสผู้แต่ง :</td>
          		        <td><input name="authID" type="text" class="form-control" value="<?=$data2['authID'];?>" size="70" readonly></td>
       		          </tr>
          		      <tr>
          		        <td height="40">ชื่อผู้แต่ง :</td>
          		        <td><input name="authName" type="text" required class="form-control" value="<?=$data2['authName'];?>" autofocus size="70" ></td>
       		          </tr>
          		      <tr>
          		        <td height="40">&nbsp;</td>
				  ...
				  window.location='auther_update.php?id=$_GET[id]'
				  </script>
				  ";
				  }
				  mysqli_close($conn);
