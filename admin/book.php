      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><a href="book_list.php" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span> กลับ</a></h3>
          	<?php
			$id=$_GET['id'];
			include('config.php');
			$sql="select *
			from books b,auther au,publisher pub,category cat
			where b.bID='$id'
			AND b.authID = au.authID
			AND b.CatID = cat.CatID
			AND b.pubID = pub.pubID
			";
			...
			?>
          	<div class="row mt">
				...
				<img src="../img/<?=$data['bPic'];?>" width="300" class="img-thumbnail"></br>
				<a href='book_add.php' class="btn btn-xs btn-success"><span class="glyphicon glyphicon-plus"></span>เพิ่มใหม่</a>
				<a href='book_update.php?id=<?=$data['bID']?>' class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-pencil"></span> แก้ไข</a>
				<a href='book_delete.php?id=<?=$data['bID']?>' onClick="return confirm('ยืนยันการลบ?');"class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span> ลบ</a>

				</div>
				<div class="col-lg-8" >

				<b>ชื่อหนังสือ :</b> <?=$data['bName'];?> <br/>
				<b>ผู้แต่ง :</b> <?=$data['authName'];?><br/>
				<b>สำนักพิมพ์ :</b> <?=$data['pubName'];?><br/>
				<b>ISBN :</b> <?=$data['ISBN'];?> <br/>
				<b>หมวดหมู่ : </b><?=$data['CatName'];?><br/>
				<b>ราคา : </b><?=$data['bPrice'];?><br/>
				<b>เหลือ :</b><?=$data['bCount'];?><br/>
				<b>หน้าปก</b><?=$data['bCover'];?><br/>
				<b>กระดาษ :</b><?=$data['bPaper'];?><br/>
				<b>วันที่นำเข้า :</b><?=$data['added_date'];?><br/>
				<pre><h4>คำอธิบายหนังสือ :</h2><?=$data['bDesc'];?> </pre><br/>
