...
include('session.php');
include('config.php');
$sql2 = "select max(pubID) as pub  from publisher";
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
          		  ...
          		  <form id="form1" name="form1" method="post" class="form-inline">
          		    <table>
          		      <tr>
          		        ...
          		        <td><input name="pubID" type="text" class="form-control" value="<?=$ID?>"  readonly size="70"></td>
       		          </tr>
          		      <tr>
          		        <td height="40">ชื่อสำนักพิมพ์ :</td>
          		        <td><input name="pubName" type="text" required class="form-control" size="70" autofocus></td>
       		          </tr>
          		      <tr>
          		        <td height="40">&nbsp;</td>
				  ...
				  $name = $_POST['pubName'];
				  $sql ="Insert into publisher values ('','$name')";
